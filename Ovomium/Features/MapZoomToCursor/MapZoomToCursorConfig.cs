...
namespace Ovomium.Features.MapZoomToCursor
{
    ...
    internal static class MapZoomToCursorConfig
    {
        ...
        public static void Bind(ConfigFile config)
        {
            Enabled = config.Bind("MapZoomToCursor", "Enabled", true,
                new ConfigDescription("Sur la grande carte, le zoom (molette, touches de zoom) se fait autour du point sous le curseur "
