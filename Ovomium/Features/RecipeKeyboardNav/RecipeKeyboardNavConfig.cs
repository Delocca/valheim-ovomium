...
namespace Ovomium.Features.RecipeKeyboardNav
{
    ...
    internal static class RecipeKeyboardNavConfig
    {
        ...
        public static void Bind(ConfigFile config)
        {
            Enabled = config.Bind("RecipeKeyboardNav", "Enabled", true,
                new ConfigDescription("Flèches haut/bas pour changer de recette sélectionnée dans toute station d'artisanat.",
