    ...
    internal static class FoodMarkerConfig
    {
        ...
        public static void Bind(ConfigFile config)
        {
            ...
            Enabled = config.Bind(section, "Enabled", true,
                "Préfixer le nom des plats d'un point coloré par stat dominante : rouge vie, jaune endurance, bleu eitr (plusieurs points si mixte). " +
            ...
            GlyphScale = config.Bind(section, "GlyphScale", 70,
                new ConfigDescription("Taille du marqueur en pourcentage de la taille du texte.", new AcceptableValueRange<int>(20, 200)));
        }
    }
}
