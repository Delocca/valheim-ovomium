...
{
    /// <summary>
    /// Mots de passe serveur mémorisés : fichier BepInEx/config/ovo.ovomiam.passwords.txt, une ligne par serveur
    ...
    {
        private const string FileName = "ovo.ovomiam.passwords.txt";
